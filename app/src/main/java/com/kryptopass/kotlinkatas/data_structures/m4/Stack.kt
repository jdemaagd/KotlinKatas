...
class Stack<E> {
    ...
    // NOTE: write API to push all elements of an array to stack
    ...
    // NOTE: write API to pop given number of elements from stack
    fun pop(count: Int) {
...
// NOTE: write API called stackOf() which works similar to arrayOf()
