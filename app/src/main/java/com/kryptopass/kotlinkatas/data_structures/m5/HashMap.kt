package com.kryptopass.kotlinkatas.data_structures.m5
...
class HashMap<K, V> {
    ...
    // NOTE: modify HashMap to have a constructor which accepts a Map<K, V> object to create itself
    ...
    private fun fetchNearestCapacity(i: Int): Int {
        ...
        // "Smear" high-order bit all the way to right
...
fun main() {
    ...
    val moreFruits = HashMap(fruits)
    moreFruits.put("D", "Dates")
    println(moreFruits.get("A"))
    println(moreFruits.get("D"))
    println(moreFruits.get("M"))
    moreFruits.put("M", "Mango")
    println(moreFruits.get("M"))
    moreFruits.put("A", "Apricot")
    println(moreFruits.get("A"))
}