...
Given sequence of up and down steps during a hike, find and print number of valleys walked through.

Example
steps = 8, path = [D,D,U,U,U,U,D,D]
Hiker first enters a valley `2` units deep. Then climbs out and up onto a mountain `2` units high.
 ...
 */
fun main() {
    countingValleys(8, "UDDDUDUU").also(::println)
    countingValleys(12, "DDUUDDUDUUUD").also(::println)
}
